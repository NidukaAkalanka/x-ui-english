...
info_bar(){
    clear
    echo -e ${GREEN}"-------------------------------------------------------------"
    echo -e ${GREEN} " __  __          _   _ ___    ___           _ _    _        "
    echo -e ${GREEN} " \ \/ /         | | | |_ _|  | __|_ _  __ _| (_)__| |_      "
    echo -e ${GREEN} "  \  /   _____  | | | || |   | _|| ' \/ _` | | (_-< ' \     "
    echo -e ${GREEN} "  /  \  |_____| | |_| || |   |___|_||_\__, |_|_/__/_||_|    "
    echo -e ${GREEN} " /_/\_\          \___/|___|  ________ |___/  _____________  "
    echo -e ${GREEN "-------------------------------------------------------------"
    echo ""
...
install_xui() {
    ...
    echo -e ${GREEN} "  \  /   _____  | | | || |    | _|| ' \/ _` | | (_-< ' \ "
    echo -e ${GREEN} "  /  \  |_____| | |_| || |    |___|_||_\__, |_|_/__/_||_|"
    echo -e ${GREEN} " /_/\_\          \___/|___|            |___/             "
    echo -e ${GREEN}"-----------------------------------------------------"
    echo -e ${GREEN}"X-UI MANAGEMENT SCRIPT USAGE: "
    echo -e ${GREEN}"--------------------------------------------------"
    echo -e ${GREEN}"x-ui              - Show the management menu"
    echo -e ${GREEN}"x-ui start        - Start X-UI panel"
    echo -e ${GREEN}"x-ui stop         - Stop X-UI panel"
    echo -e ${GREEN}"x-ui restart      - Restart X-UI panel"
    echo -e ${GREEN}"x-ui status       - View X-UI status"
    echo -e ${GREEN}"x-ui enable       - Set X-UI boot self-starting"
    echo -e ${GREEN}"x-ui disable      - Cancel X-UI boot self-starting"
    echo -e ${GREEN}"x-ui log          - View x-ui log"
    echo -e ${GREEN}"x-ui v2-ui        - Migrate V2-UI to X-UI"
    echo -e ${GREEN}"x-ui update       - Update X-UI panel"
    echo -e ${GREEN}"x-ui install      - Install X-UI panel"
    echo -e ${GREEN}"x-ui uninstall    - Uninstall X-UI panel"
    echo -e ${GREEN}"---------------------------------------------------"
    echo -e ${GREEN}"---------------------------------------------------"
    echo -e ${GREEN}"Please do consider supporting authors"
    echo -e ${GREEN}"---------------------------------------------------"
    echo -e ${GREEN}"vaxilu            - https://github.com/vaxilu" 
    echo -e ${GREEN}"taffychan         - https://github.com/taffychan"  
    echo -e ${GREEN}"LuckyHunter       - https://github.com/Chasing66"
    echo -e ${GREEN}"Yu FranzKafka     - https://github.com/FranzKafkaYu"
    echo -e ${GREEN}"Niduka Akalanka   - https://github.com/NidukaAkalanka"
    echo -e ${GREEN}"---------------------------------------------------"
    show_login_info
    echo -e ""
