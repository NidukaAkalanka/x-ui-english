...
func (s *Server) startTask() {
	...
	go func() {
		...
		// Traffic is counted every 10 seconds, and the first startup is delayed by 5 seconds, which is staggered from the time of restarting xray
	...
	// The traffic status is prompted once a day, at 8:30 Shanghai time
